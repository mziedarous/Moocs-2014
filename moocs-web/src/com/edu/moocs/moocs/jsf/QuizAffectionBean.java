...
public class QuizAffectionBean implements Serializable{
	...
	public String goToChapters(){
		...
		chapters = couseManagementLocal.findAllChapterByCourseAndHasQuiz(course);
		...
		{
			RequestContext.getCurrentInstance().showMessageInDialog(new FacesMessage(FacesMessage.SEVERITY_INFO, "Remark !!", "this course heven t chapter!!"));
	...
	public String doAffectQuizToChapter(){
		...
		RequestContext.getCurrentInstance().showMessageInDialog(new FacesMessage(FacesMessage.SEVERITY_INFO, "Remark !!", "This quiz is aready affected !!"));
		return "";
		}
		else
		{	
