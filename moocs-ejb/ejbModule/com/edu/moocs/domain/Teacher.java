...
public Teacher(String firstName, String lastName, Long cin, Date dateOfBirth,
		String sexe, String mail, String login, String password, String diploma) {
...
public String toString() {
	return "Teacher [diploma=" + diploma + ", getId()=" + getId()
			...
			+ getLastName() + ", getCin()=" + getCin() + ", getDateOfBirth()="
			+ getDateOfBirth() + ", getSexe()=" + getSexe() + ", getMail()="
			+ getMail() + ", getLogin()=" + getLogin() + ", getPassword()="
