 ...
 */
@Stateless
public class ProfilsManagementService implements ProfilsManagementServiceRemote, ProfilsManagementServiceLocal {
	...
	public User autehnticate(String login, String password) {
		...
		Query query =em.createQuery("select u from User u where u.login=:x and u.password=:y");
